...
Route::middleware("locale")->group(function(){
    ...
    Route::prefix('profile')->group(function(){
        Route::get('/',[ArticleController::class,'index'])->name('sportsmen.list');
            Route::get('create',[ArticleController::class,'createArticle'])->middleware(['auth','is_admin'])->name('sportsmen.create');
            Route::post('create',[ArticleController::class,'storeArticle'])->middleware(['auth','is_admin'])->name('sportsmen.store');
            Route::get('{sportsmanId}/edit',[ArticleController::class,'editArticle'])->middleware(['auth','is_admin'])->name('sportsmen.edit');
            Route::put('{sportsmanId}/edit',[ArticleController::class,'updateArticle'])->middleware(['auth','is_admin'])->name('sportsmen.edit');
            Route::delete('{sportsmanId}',[ArticleController::class,'deleteArticle'])->middleware(['auth','user'])->name('sportsmen.delete');
            Route::get('{sportsmanSlug}',[ArticleController::class,'show'])->middleware(['auth','user'])->name('sportsmen.show');
            Route::get('{sportsmanId}/remove-image',[ArticleController::class,'removeImage'])->middleware(['auth','is_admin'])->name("sportsmen.remove-image");
        Route::post('logout',[AuthControler::class,'logout'])->middleware('guest')->name('auth.logout');
    });
});
